...
The Bayesian regression techniques overwhelmingly outperform the remaining methods, with the exception of the hierarchical feature regression and perhaps the adaptive lasso, both of which achieve relatively high out-of-sample performance. The subset selection algorithms achieve relatively good results, while the penalized and latent factor regressions perform worst. All methods improve on the OLS results.
