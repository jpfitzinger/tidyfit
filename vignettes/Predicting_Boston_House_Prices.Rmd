...
The Bayesian regression techniques achieve the highest out-of-sample performance, followed by the hierarchical feature regression. The subset selection algorithms achieve relatively good results, while the penalized and latent factor regressions perform worst. All methods improve on the OLS results.
