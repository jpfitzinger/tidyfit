...
if (use_saved_results) {
  ...
  mod_rolling <- results$mod_rolling
  mod_tvp <- results$mod_tvp
}
```
...
```{r, include=FALSE}
results <- list(mod_rolling = mod_rolling, mod_tvp = mod_tvp)
saveRDS(results, "vignettes/vignette_tvpvsrw.rds")
```
