...
if (use_saved_results) {
  ...
  mod_frame_hac <- results$mod_frame_hac
  mod_frame_rolling <- results$mod_frame_rolling
}
```
...
```{r, include=FALSE}
results <- list(mod_frame_rolling = mod_frame_rolling, mod_frame_hac = mod_frame_hac)
saveRDS(results, "vignettes/vignette_rwtsr.rds")
```
