#' @name cluster
#' @title Clustering on tidy data
#' @description This function is a wrapper to fit many different types of cluster
#' algorithms on a (grouped) \code{tibble}.
#'
...
cluster <- function(
  ...
  .check_method(method_names, "cluster", message = TRUE)
