...
#'
#' The ridge regression is estimated using \code{glmnet::glmnet} with \code{alpha = 0}. For classification pass \code{family = "binomial"}  to \code{control} or to the argument \code{...} in \code{\link{m}}.
#'
