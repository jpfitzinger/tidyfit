...
#' @description Fits a linear regression or classification and returns the results as a tibble. The function can be used with \code{tidyfit}.
#'
#' @details The Lasso regression is estimated using \code{glmnet::glmnet} with \code{alpha = 1}.
#'
