...
tbl <- data.frame(
  Method = c("OLS", "GLS", "Robust regression (e.g. Huber loss)", 
             ...
             "Hierarchical feature regression", "Best subset selection", "General-to-specific", "Bayesian regression", "Bayesian Ridge", "Bayesian Lasso", "Bayesian model averaging", "Bayesian time-varying parameters regression", "Generalized mixed-effects regression", "Markov-switching regression", "Pearson correlation", "Chi-squared test", "Minimum redundancy, maximum relevance", "ReliefF"),
  Name = c("lm", "glm", "robust", "quantile", "lasso", "ridge", "adalasso", "enet", "boost", "svm", "rf", "pcr", "plsr", 
           "hfr", "subset", "gets", "bayes", "bridge", "blasso", "bma", "tvp", "glmm", "mslm", "cor", "chisq", "mrmr", "relief"),
  Package = c("`stats`", "`stats`", "`MASS`", "`quantreg`", "`glmnet`", "`glmnet`", "`glmnet`", "`glmnet`",
              "`mboost`", "`e1071`", "`randomForest`", "`pls`", "`pls`", "`hfr`", "`bestglm`", "`gets`", "`arm`", "`monomvn`", "`monomvn`", "BMS", "`shrinkTVP`", "`lme4`", "`MSwM`", "`stats`", "`stats`", "`mRMRe`", "`CORElearn`"),
  Regression = c("yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "no", "yes", "yes"),
  Classification = c("no", "yes", "no", "no", "yes", "yes", "yes", "yes", "yes", "yes", "yes", "no", "no", "no", "yes", "no", "yes", "no", "no", "no", "no", "yes", "no", "no", "yes", "yes", "yes"),
  group = c("Linear (generalized) regression or classification", "Linear (generalized) regression or classification", "Linear (generalized) regression or classification", "Linear (generalized) regression or classification", "Regression or classification with L1 and L2 penalties", "Regression or classification with L1 and L2 penalties", "Regression or classification with L1 and L2 penalties", "Regression or classification with L1 and L2 penalties", "Machine Learning", "Machine Learning", "Machine Learning", "Factor regressions", "Factor regressions", "Factor regressions", "Subset selection", "Subset selection", "Bayesian regression", "Bayesian regression", "Bayesian regression", "Bayesian regression", "Bayesian regression", "Mixed-effects modeling", "Specialized time series methods", "Feature selection", "Feature selection", "Feature selection", "Feature selection")
)
